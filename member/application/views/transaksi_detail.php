...
<div class="row mb-5">
        <div class="row g-4">
            <!-- Transaksi Card -->
            <div class="col-md-3">
                <div class="card h-100 shadow-sm border-0" style="transition: transform .2s;" onmouseover="this.style.transform='scale(1.03)'" onmouseout="this.style.transform='scale(1)'">
                    <div class="card-body">
                        <h5 class="card-title"><i class="bi bi-receipt-cutoff me-2"></i>Transaksi</h5>
                        <p class="mb-1"><strong>ID:</strong> <?php echo $transaksi['id_transaksi'] ?></p>
                        <p class="mb-1"><strong>Tanggal:</strong> <?php echo date('d M Y H:i', strtotime($transaksi['tanggal_transaksi'])) ?></p>
            ...
            <div class="col-md-3">
                <div class="card h-100 shadow-sm border-0" style="transition: transform .2s;" onmouseover="this.style.transform='scale(1.03)'" onmouseout="this.style.transform='scale(1)'">
                    <div class="card-body">
                        <h5 class="card-title"><i class="bi bi-person-fill me-2"></i>Pengirim</h5>
                        <p class="mb-1"><strong>Nama:</strong> <?php echo $transaksi['nama_pengirim'] ?></p>
                        <p class="mb-1"><strong>WA:</strong><?php echo $transaksi['wa_pengirim'] ?></p>
                        <p class="mb-0"><strong>Alamat:</strong> <?php echo $transaksi['alamat_pengirim'] ?>, <?php echo $transaksi['distrik_pengirim'] ?></p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-3">
                <div class="card h-100 shadow-sm border-0" style="transition: transform .2s;" onmouseover="this.style.transform='scale(1.03)'" onmouseout="this.style.transform='scale(1)'">
                    <div class="card-body">
                        <h5 class="card-title"><i class="bi bi-person-check-fill me-2"></i>Penerima</h5>
                        <p class="mb-1"><strong>Nama:</strong> <?php echo $transaksi['nama_penerima'] ?></p>
                        <p class="mb-1"><strong>WA:</strong><?php echo $transaksi['wa_penerima'] ?></p>
                        <p class="mb-0"><strong>Alamat:</strong> <?php echo $transaksi['alamat_penerima'] ?>, <?php echo $transaksi['distrik_penerima'] ?></p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-3">
                <div class="card h-100 shadow-sm border-0" style="transition: transform .2s;" onmouseover="this.style.transform='scale(1.03)'" onmouseout="this.style.transform='scale(1)'">
                    <div class="card-body">
                        <h5 class="card-title"><i class="bi bi-truck me-2"></i>Ekspedisi</h5>
                        <p class="mb-1"><strong>Nama:</strong> <?php echo $transaksi['nama_ekspedisi'] ?></p>
                        <p class="mb-1"><strong>Layanan:</strong> <?php echo $transaksi['layanan_ekspedisi'] ?></p>
                        <p class="mb-1"><strong>Estimasi:</strong> <?php echo $transaksi['estimasi_ekspedisi'] ?></p>
                        <p class="mb-1"><strong>Berat:</strong> <?php echo $transaksi['berat_ekspedisi'] ?></p>
                        <p class="mb-0"><strong>Resi:</strong>
                            <?php if (empty($transaksi['resi_ekspedisi'])): ?>
                                <?php echo 'Belum tersedia'; ?>
                            <?php else: ?>
                                <?php echo $transaksi['resi_ekspedisi']; ?>
                            <?php endif; ?>
                            <!-- Tombol salin dengan SweetAlert -->
                            <?php if (!empty($transaksi['resi_ekspedisi'])): ?>
                                <button class="btn btn-sm btn-outline-secondary ms-2" onclick="copyToClipboard('<?php echo $transaksi['resi_ekspedisi'] ?>')">
    ...
    <?php if (!empty($snapToken)): ?>
        <script src="https://app.sandbox.midtrans.com/snap/snap.js" data-client-key="SB-Mid-client-Fe0oGpm-tq7YIZTi"></script>
        ...
        navigator.clipboard.writeText(text)
            .then(() => {
                Swal.fire({
                    ...
                    showClass: {
                        popup: 'swal2-show animate_animated animate_fadeInDown'
                    },
                    hideClass: {
                        popup: 'swal2-hide animate_animated animate_fadeOutUp'
                    },
                    iconHtml: '<i class="fa fa-check-circle" style="font-size:36px;color:green;"></i>'
                });
            })
            .catch(() => {
                Swal.fire({
