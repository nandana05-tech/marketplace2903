...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-light bg-light">
    <div class="container">
      <a href="" class="navbar-brand">TokoKita</a>
          ...
          <ul class="navbar-nav ms-auto">
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu">
                ...
                <li>
                  <a class="dropdown-item" href="<?php echo base_url("seller/produk/laporan_terjual") ?>">Laporan Produk</a>
                </li>
                <li>
            ...
            <li class="nav-item">
              <a href="<?php echo base_url("akun") ?>" class="nav-link"><?php echo $this->session->userdata("nama_member"); ?></a>
            </li>
            <li class="nav-item">
