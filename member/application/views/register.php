        ...
        <div class="col-md-8 offset-md-2">
            ...
            <form action="" method="post">
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control" name="alamat_member" id=""><?php echo set_value("alamat_member") ?></textarea>
                ...
                <div class="mb-3">
                    ...
                    <!-- Input Search akan ditambahkan lewat JavaScript -->
                    <select class="form-control form-select" name="city_id" id="citySelect">
