...
<footer class="bg-light text-center py-4 mt-5 shadow-sm"
        style="border-top: 1px solid #dee2e6; font-size: 0.95rem;">
  <div style="color: #6c757d; transition: color 0.3s;"
       onmouseover="this.style.color='#000'" 
       onmouseout="this.style.color='#6c757d'">
    &copy; <?php echo date("Y"); ?> <strong>TokoKita</strong>. All rights reserved.
  </div>
</footer>
